...
interface InventoryReportPeriodFiltersProps {
  value: InventoryReportPeriodConfig;
  onChange: (config: InventoryReportPeriodConfig) => void;
}

export function InventoryReportPeriodFilters({
  value,
  onChange,
}: InventoryReportPeriodFiltersProps) {
  const setMode = (mode: InventoryReportPeriodMode) => onChange({ ...value, mode });
  ...
  return (
    <div className="space-y-3 rounded-lg border bg-muted/20 p-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Tabs value={value.mode} onValueChange={(v) => setMode(v as InventoryReportPeriodMode)}>
